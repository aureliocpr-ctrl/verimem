"""Prompt-injection / memory-poisoning detector (verimem.prompt_injection).
...
malicious form of the "weak-admission hole" that verimem.admission_gate cites
...
Design discipline (mirrors verimem.redaction): anchored, length-bounded
