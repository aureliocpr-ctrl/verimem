...
file pins the contract of ``attic.hooks.pre_tool_use``:
...
RED→GREEN — this file must fail import on ``attic.hooks.pre_tool_use``
...
# RED MARKER
from attic.hooks.pre_tool_use import (
    extract_step_text,
    main_stdin_stdout,
    run,
)
