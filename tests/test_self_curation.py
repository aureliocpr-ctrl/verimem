...
class TestClassifyContradictionsPureFunction:
    ...
    def test_safe_supersede_when_one_side_superseded(
        ...
        from attic.self_curation import classify_contradiction
...
class TestAutoResolveFalsePositives:
    ...
    def test_resolves_fp_likely_only(
        ...
        from attic.self_curation import auto_resolve_false_positives
        now = time.time()
        # FP_LIKELY pair
...
class TestAuditOnly:
    ...
    def test_audit_reports_counts(
        ...
        from attic.self_curation import audit_contradictions
        now = time.time()
        # FP_LIKELY
