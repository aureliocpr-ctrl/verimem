...
def test_module_ending_in_p_or_y_not_corrupted():
    ...
    assert _module_to_dotted("engram/policy.py") == "engram.policy"
    assert _module_to_dotted("engram/registry.py") == "engram.registry"
    assert _module_to_dotted("engram/copy.py") == "engram.copy"
    assert _module_to_dotted("engram/entropy.py") == "engram.entropy"


def test_normal_module_unaffected():
    assert _module_to_dotted("engram/semantic.py") == "engram.semantic"
...
def test_init_collapses_to_package():
    ...
    assert _module_to_dotted("engram/sub/__init__.py") == "engram.sub"
