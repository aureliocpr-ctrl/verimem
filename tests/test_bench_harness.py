...
from attic.bench_harness import (
    ProviderSpec,
    RunResult,
    TaskCase,
    _val_contains,
...
def test_skill_compounding_suite_shape():
    ...
    from attic.bench_harness import skill_compounding_suite
...
def test_memory_recall_suite_shape():
    ...
    from attic.bench_harness import memory_recall_suite
...
def test_hard_memory_recall_suite_shape():
    ...
    from attic.bench_harness import hard_memory_recall_suite
...
def test_aggregate_by_iter_groups_by_iteration():
    ...
    from attic.bench_harness import aggregate_by_iter
    rs = [
        RunResult(condition="hippo_warm", provider="p", task_id="t1",
...
def test_aggregate_empty_results():
    ...
    from attic.bench_harness import aggregate
    assert aggregate([]) == {}
...
def test_from_jsonable_round_trips():
    ...
    from attic.bench_harness import from_jsonable, to_jsonable
    rs = [
        RunResult(condition="raw", provider="p", task_id="t1",
...
def test_merge_results_concatenates():
    from attic.bench_harness import merge_results
...
def test_aggregate_by_task_groups_correctly():
    ...
    from attic.bench_harness import aggregate_by_task
    rs = [
...
def test_from_jsonable_handles_missing_extras():
    ...
    from attic.bench_harness import from_jsonable
    rs = from_jsonable([{
