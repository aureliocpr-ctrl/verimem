"""Ingest dei transcript .jsonl di Claude Code nel Tier C (attic.transcript_ingest).
...
from attic.transcript_ingest import ingest_dir, ingest_session, parse_turns
