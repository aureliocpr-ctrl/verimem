"""Reversible backlog cleanup for the admission gate (engram.admission_cleanup).

The admission gate (engram.admission_gate, opt-in) governs only NEW writes. This
...
def cleanup_episode_telemetry(db_path, *, dry_run: bool = True) -> dict:
    ...
    Decision reuses :func:`engram._call_telemetry.is_call_telemetry` — the SAME
