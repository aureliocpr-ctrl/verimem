...
``engram.consolidation`` (pairwise greedy, cycle #144) and
``engram.dream.propose_dream_tasks`` (cluster → LLM synthesis, cycle
#34/#35).
...
from engram.embedding import expected_embedding_bytes
from engram.topic_normalization import normalize_topic

if TYPE_CHECKING:
    from engram.stable_partition import Partition
