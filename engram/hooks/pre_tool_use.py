...
:meth:`engram.proactive_step_injector.StepInjector.inject` against the
...
def _default_agent_factory() -> Any | None:
    ...
    if sem_db is None:
        return None
    try:
        from engram.semantic import SemanticMemory  # noqa: PLC0415
...
def run(
    ...
    *,
    ...
    try:
        from engram.proactive_step_injector import (  # noqa: PLC0415
            StepInjector,
        )
