"""Admission gate for the curated semantic corpus (engram.admission_gate).
...
# SINGLE SOURCE OF TRUTH (engram._telemetry_prefixes) shared with the recall-time
# denylist in engram.semantic: the read side HIDES these, this gate keeps them out
