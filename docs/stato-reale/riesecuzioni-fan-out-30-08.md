...
NOTA: il banco LEGGE il DB di produzione `C:\Users\<utente>\.engram\semantic\semantic.db` (popolazione 5948, sola lettura — è il suo scopo "corpus vero"); a runtime emette `RuntimeWarning` da `verimem/anti_confab_gate.py:2400` (cut del judge locale 99.6 inutilizzabile, usa il cut CE validato 40) e testa alla porta solo 12 dei 26 nuovi, estrapolando il fattore 1.00 all'intero costo.
