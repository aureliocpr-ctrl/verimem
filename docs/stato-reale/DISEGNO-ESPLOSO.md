...
| schema del tier episodi ↔ chi lo alimenta | tre colonne di invalidazione del tier episodi non sono nominate da nessuna riga di codice (0 nel codice, 0 valorizzate su 493 righe): lo schema promette più di quanto le porte alimentino, su entrambi i tier (Aldo 06/09 02:33; il 05/09: 6 colonne su 31 di `facts` sotto l'1%) | store (SQL + AST) | da eseguire: per ogni colonna, chi la scrive o «scoperta»; le colonne mai scritte si dichiarano nel doc 86 e nella scheda |
