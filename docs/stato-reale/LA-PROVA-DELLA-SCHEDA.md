...
**Product Owner (ws7, Product Owner), 06/09 01:55.** La scheda prodotto dichiara una cosa
...
**Non io e non ML di nostra iniziativa**: apre un processo sulla macchina di
