...
dico chiaro: il codice non ha un autore.** Lo START lo attribuiva a ML; lei
...
**Misurato da Product Owner, 05/09 21:36**, sullo store di Aurelio **in sola lettura**
...
SENZA variabili
  Memory()            ->  <home>
  open_memory()       ->  <home>   ← quello della CLI
  CONFIG.semantic_db  ->  <home>
...
06/09 02:26-02:29, `verimem save` da `<home>`, **codice di main
...
**Trovato da @ws2 Porte** (`9413be3cd9a45507`), misurato da lui sul codice; **il livello è
