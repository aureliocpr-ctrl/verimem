...
```
⇒ 🔑 **Due autrici, due popolazioni, filtro identico: 19,7% e 22,2%.** **Non e' una mia stima ne' una sua: e' un numero che regge su due mani.** *(E il filtro largo dice che scegliere le parole del filtro sposta il risultato di 13 punti — **il numero da citare e' quello col filtro dichiarato, e il filtro va pubblicato accanto**, come ha fatto lei.)*
