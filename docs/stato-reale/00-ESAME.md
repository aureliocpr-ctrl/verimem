...
| W7-7 | il gate ferma uno **scambio di attribuzione** (chi ha fatto cosa)? | C5 | — | SDK | 🔴🔴 **no: 5 su 5, ground 99,7–100,0, zero layer** | ws4 (riportata da ws7) | ⚠️ **E nello STESSO topic CANCELLA il fatto vero** (same-source evolution); con topic separati i due convivono. 🎯 **Segnalata dall'autrice come urgente per la 0.7.5** — apre la classe **C5 identità** |

### Il conto, aggiornato a mano quando cambia

    🔴 rossi 27 · 🟢 verdi 17 · 🟡 parziali 5   (su 50 celle, 27/08 ore 22:00)
