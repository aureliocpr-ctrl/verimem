...
```
tool MCP        hippo_skills_untested
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skills_untested.py:13` `find_untested_skills` | funzione: Return skills with trials == 0. | `verimem/mcp_server.py:11144`; `verimem/mcp_server.py:11145`; `verimem/skills_untested.py:35` | `tests/test_skills_untested.py` | - | NON MISURATO | - |
