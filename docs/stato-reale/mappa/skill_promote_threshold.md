# `verimem/skill_promote_threshold.py`
...
```
tool MCP        hippo_skill_promote_by_threshold
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_promote_threshold.py:12` `promote_by_threshold` | funzione: Promote candidate skills meeting both thresholds. | `verimem/mcp_server.py:11082`; `verimem/mcp_server.py:11083`; `verimem/skill_promote_threshold.py:60` | `tests/test_skill_promote_by_threshold.py` | - | NON MISURATO | - |
