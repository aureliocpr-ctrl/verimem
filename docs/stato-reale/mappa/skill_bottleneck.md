...
```
tool MCP        hippo_skill_bottlenecks
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_bottleneck.py:17` `find_bottlenecks` | funzione: Identify high-leverage skill bottlenecks. | `verimem/mcp_server.py:10314`; `verimem/mcp_server.py:10315`; `verimem/skill_bottleneck.py:67` | `tests/test_skill_bottleneck.py` | - | NON MISURATO | - |
