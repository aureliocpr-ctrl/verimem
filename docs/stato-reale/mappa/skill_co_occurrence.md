...
```
tool MCP        hippo_skills_co_occurrence
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_co_occurrence.py:16` `skill_co_occurrence` | funzione: Compute the symmetric skill co-occurrence + Jaccard. | `verimem/mcp_server.py:12120`; `verimem/mcp_server.py:12128`; `verimem/skill_co_occurrence.py:67` (+2) | `tests/test_memory_skill_cooccurrence.py`; `tests/test_skill_co_occurrence.py`; `tests/test_wake_skill_co_occurrence.py` | - | NON MISURATO | - |
