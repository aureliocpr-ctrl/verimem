...
```
tool MCP        hippo_skill_provenance
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_provenance.py:11` `skill_provenance` | funzione: Resolve `skill.provenance_episodes` ids to full episode records. | `verimem/mcp_server.py:11073`; `verimem/mcp_server.py:11074`; `verimem/skill_provenance.py:52` | `tests/test_skill_provenance.py` | - | NON MISURATO | - |
