...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_recover.py:12` `recover_skill` | funzione: Move retired skill back to candidate. | `verimem/mcp_server.py:9694`; `verimem/mcp_server.py:9695`; `verimem/skill_recover.py:62` | `tests/test_skill_recover.py` | - | NON MISURATO | - |
