# `verimem/swarm/state.py` — 97 righe

## Cosa fa
legge lo stato di una sessione bg. Il supervisore di Claude scrive `~/.claude/jobs/<short_id>/state.json`: questo modulo lo interpreta. Cycle #148, 18/05/2026.
