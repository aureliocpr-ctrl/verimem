# `verimem/skill_stuck_diagnostic.py`
...
```
tool MCP        hippo_stuck_candidates_report
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_stuck_diagnostic.py:32` `stuck_candidates_report` | funzione: Identify candidate skills stuck at trials==0 for more than min_age_days. | `verimem/mcp_server.py:9910`; `verimem/mcp_server.py:9913`; `verimem/skill_stuck_diagnostic.py:114` | `tests/test_skill_stuck_diagnostic.py` | - | NON MISURATO | - |
