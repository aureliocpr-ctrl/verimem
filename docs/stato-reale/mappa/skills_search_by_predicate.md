# `verimem/skills_search_by_predicate.py`
...
```
tool MCP        hippo_skills_search_by_predicate
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skills_search_by_predicate.py:13` `skills_with_predicate` | funzione: Filter skills containing `predicate` in pre/post. | `verimem/mcp_server.py:11107`; `verimem/mcp_server.py:11108`; `verimem/skills_search_by_predicate.py:54` | `tests/test_skills_search_by_predicate.py` | - | NON MISURATO | - |
