...
```
tool MCP        hippo_skills_top_used
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skills_top_used.py:12` `top_used_skills` | funzione: Count distinct episodes per skill, return top N. | `verimem/mcp_server.py:10685`; `verimem/mcp_server.py:10693`; `verimem/skills_top_used.py:33` | `tests/test_skills_top_used.py` | - | NON MISURATO | - |
