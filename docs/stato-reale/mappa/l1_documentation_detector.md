# `verimem/l1_documentation_detector.py` — L1.14
...
```
(1) SCATTA su      «Le API sono documentate.»           senza evidenza → ✅ warning
(2) NON scatta su  «Le API espongono sei rotte.»    → ✅ nessun warning
...
copertura: 85.4%
statement non eseguiti: 53, 58->51, 62, 71
```
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/l1_documentation_detector.py:43` `DocClaimWarning` | classe: (nessun docstring) | `verimem/l1_documentation_detector.py:69`; `verimem/l1_documentation_detector.py:78`; `verimem/l1_documentation_detector.py:89` | `tests/test_l1_documentation_detector.py` | - | NON MISURATO | - |
| 2 | `verimem/l1_documentation_detector.py:48` `_has_doc_evidence` | funzione: (nessun docstring) | `verimem/l1_documentation_detector.py:76` | nessuno | - | **FUNZIONA COME PROMESSO** | eseguita, 2/11 statement del corpo scoperti (755 passed, EXIT=0) |
| 3 | `verimem/l1_documentation_detector.py:65` `detect_unsupported_doc_claim` | funzione: (nessun docstring) | `verimem/anti_confab_gate.py:93`; `verimem/anti_confab_gate.py:1568`; `verimem/l1_documentation_detector.py:89` | `tests/test_l1_documentation_detector.py` | - | **FUNZIONA COME PROMESSO** | banco famiglia: scatta su «Le API sono documentate.…» senza evidenza, tace sulla prosa innocua; 755 passed, 6 xfailed, EXIT=0; modulo al 85.4% |
