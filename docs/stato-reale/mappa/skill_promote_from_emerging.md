# `verimem/skill_promote_from_emerging.py`
...
```
tool MCP        hippo_emerging_skill_promote
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_promote_from_emerging.py:41` `_name_slug` | funzione: Derive a Skill.name slug from the fact topic. | `verimem/skill_promote_from_emerging.py:91` | nessuno | - | NON MISURATO | - |
| 2 | `verimem/skill_promote_from_emerging.py:51` `_extract_keywords` | funzione: Pull the comma-list out of the 'Trigger keywords: ...' line. | `verimem/skill_drafter.py:77`; `verimem/skill_drafter.py:188`; `verimem/skill_promote_from_emerging.py:92` | nessuno | - | NON MISURATO | - |
| 3 | `verimem/skill_promote_from_emerging.py:63` `promote_emerging_to_skill` | funzione: Convert an ``emerging_skill/*`` fact into a candidate Skill row. | `verimem/mcp_server.py:10741`; `verimem/mcp_server.py:10773`; `verimem/skill_promote_from_emerging.py:152` | `tests/test_skill_promote_from_emerging.py` | - | NON MISURATO | - |
