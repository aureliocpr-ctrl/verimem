...
```
tool MCP        hippo_mine_skill_combos
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_combo_mining.py:17` `mine_skill_combos` | funzione: Mine frequently co-occurring skill pairs. | `verimem/mcp_server.py:10230`; `verimem/mcp_server.py:10237`; `verimem/skill_combo_mining.py:60` | `tests/test_skill_combo_mining.py` | - | NON MISURATO | - |
