...
```
tool MCP        hippo_skill_usage_decay
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_usage_decay.py:15` `usage_decay` | funzione: Compute decay score per skill, sorted descending. | `verimem/mcp_server.py:11154`; `verimem/mcp_server.py:11155`; `verimem/skill_usage_decay.py:54` | `tests/test_skill_usage_decay.py` | - | NON MISURATO | - |
