...
```
tool MCP        hippo_skill_lineage_full
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_lineage_full.py:15` `skill_lineage_full` | funzione: Walk ancestors AND descendants. BFS with depth tracking and | `verimem/mcp_server.py:11461`; `verimem/mcp_server.py:11462`; `verimem/skill_lineage_full.py:88` | `tests/test_skill_lineage_full.py` | - | NON MISURATO | - |
