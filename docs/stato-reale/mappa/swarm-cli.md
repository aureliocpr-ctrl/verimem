# `verimem/swarm/cli.py` — 210 righe

## Cosa fa
la subapp Typer: i comandi per l'operatore umano e per l'agente. Cycle #148, 18/05/2026.

## Chi lo chiama
Importato da **2 — ed è il punto d'ingresso file**.
