...
```
tool MCP        hippo_predict_warmup_skills
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_warmup.py:17` `_tokens` | funzione: (nessun docstring) | `verimem/analogy.py:66`; `verimem/bm25_rank.py:124`; `verimem/bm25_rank.py:135` (+51) | `tests/test_due_domande_diverse_stessa_risposta.py`; `tests/test_l_oracolo_non_risponde_su_due_preposizioni.py`; `tests/test_le_interrogative_di_quantita_non_sono_contenuto.py` (+2) | - | NON MISURATO | - |
| 2 | `verimem/skill_warmup.py:21` `_jaccard` | funzione: (nessun docstring) | `verimem/coherence_check.py:115`; `verimem/cross_agent_consensus.py:51`; `verimem/episode_clusters.py:65` (+20) | `tests/test_il_flip_giapponese_passa_per_quindici_millesimi.py`; `tests/test_l_oracolo_non_risponde_su_due_preposizioni.py` | - | NON MISURATO | - |
| 3 | `verimem/skill_warmup.py:27` `predict_warmup_skills` | funzione: Rank skills by aggregate match to upcoming tasks. | `verimem/mcp_server.py:10204`; `verimem/mcp_server.py:10206`; `verimem/skill_warmup.py:69` | `tests/test_skill_warmup.py` | - | NON MISURATO | - |
