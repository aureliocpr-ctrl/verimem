...
```
tool MCP        hippo_skills_top_failing
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skills_top_failing.py:14` `top_failing_skills` | funzione: Return skills with the most failures. | `verimem/mcp_server.py:11127`; `verimem/mcp_server.py:11135`; `verimem/skills_top_failing.py:46` | `tests/test_skills_top_failing.py` | - | NON MISURATO | - |
