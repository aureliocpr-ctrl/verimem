# `verimem/swarm/schemas.py` — 91 righe

## Cosa fa
due record tipizzati (pydantic) che validano ogni giro dello swarm. Cycle #148, 18/05/2026.

## Chi lo chiama
Importato da **10 — il più importato del gruppo file**.
