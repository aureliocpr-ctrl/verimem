# `verimem/skill_cooccurrence_graph.py`
...
```
tool MCP        hippo_skill_cooccurrence_graph
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_cooccurrence_graph.py:18` `build_cooccurrence_graph` | funzione: Return graph as {nodes, edges} dict. | `verimem/mcp_server.py:10035`; `verimem/mcp_server.py:10041`; `verimem/skill_cooccurrence_graph.py:62` | `tests/test_skill_cooccurrence_graph.py` | - | NON MISURATO | - |
