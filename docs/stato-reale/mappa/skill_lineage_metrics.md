# `verimem/skill_lineage_metrics.py`
...
```
tool MCP        hippo_skill_lineage_metrics
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_lineage_metrics.py:16` `compute_lineage_metrics` | funzione: DAG metrics over parent_skills relationships. | `verimem/mcp_server.py:10077`; `verimem/mcp_server.py:10078`; `verimem/skill_lineage_metrics.py:72` | `tests/test_skill_lineage_metrics.py` | - | NON MISURATO | - |
| 2 | `verimem/skill_lineage_metrics.py:45` `compute_lineage_metrics.dfs` | funzione: (nessun docstring) | `verimem/predicate_graph_check.py:51`; `verimem/predicate_graph_check.py:56`; `verimem/skill_lineage_metrics.py:53` (+2) | nessuno | - | NON MISURATO | - |
