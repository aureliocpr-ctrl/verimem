...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_recent.py:12` `skills_recent` | funzione: Return last N skills, newest-first. Optional status filter. | `verimem/evidence_hint.py:5`; `verimem/mcp_server.py:10701`; `verimem/mcp_server.py:10702` (+1) | `tests/test_skill_recent.py`; `tests/test_verimem_evidence_hint.py` | - | NON MISURATO | - |
