...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_inspect.py:17` `skill_inspect` | funzione: Return everything-about-this-skill in one payload. | `verimem/mcp_server.py:11938`; `verimem/mcp_server.py:11940`; `verimem/skill_inspect.py:116` | `tests/test_skill_inspect.py` | - | NON MISURATO | - |
