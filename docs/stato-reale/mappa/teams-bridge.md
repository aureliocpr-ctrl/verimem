# `verimem/teams/bridge.py` — 84 righe

## Cosa fa
porta i messaggi della Mailbox di agent-teams dentro la memoria semantica. Il perché è dichiarato: la Mailbox di agent-teams è in-memory e locale al processo.
