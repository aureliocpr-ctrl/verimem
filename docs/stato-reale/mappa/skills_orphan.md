...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skills_orphan.py:13` `find_orphan_skills` | funzione: Find skills with no in-library parents AND no children. | `verimem/mcp_server.py:9704`; `verimem/mcp_server.py:9705`; `verimem/skills_orphan.py:44` | `tests/test_skills_orphan.py` | - | NON MISURATO | - |
