...
```
tool MCP        hippo_detect_skill_drift
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_drift.py:15` `detect_skill_drift` | funzione: Detect skills whose success rate changed significantly. | `verimem/mcp_server.py:10101`; `verimem/mcp_server.py:10107`; `verimem/skill_drift.py:87` | `tests/test_skill_drift.py`; `tests/test_skill_drift_zero_window_scan68.py` | - | NON MISURATO | - |
