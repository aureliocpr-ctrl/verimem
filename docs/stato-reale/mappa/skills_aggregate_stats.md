# `verimem/skills_aggregate_stats.py`
...
```
tool MCP        hippo_skills_aggregate_stats
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skills_aggregate_stats.py:13` `aggregate_stats` | funzione: Stats grouped by stage AND status. | `verimem/mcp_server.py:10679`; `verimem/mcp_server.py:10680`; `verimem/skills_aggregate_stats.py:45` | `tests/test_skills_aggregate_stats.py` | - | NON MISURATO | - |
