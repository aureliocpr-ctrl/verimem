# `verimem/skill_promote_review.py`
...
```
tool MCP        hippo_review_promotions
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_promote_review.py:19` `review_promotions` | funzione: Suggest action per skill. | `verimem/mcp_server.py:10168`; `verimem/mcp_server.py:10169`; `verimem/skill_promote_review.py:94` | `tests/test_skill_promote_review.py` | - | NON MISURATO | - |
