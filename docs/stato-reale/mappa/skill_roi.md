...
```
tool MCP        hippo_rank_skills_roi
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_roi.py:19` `_safe_fitness` | funzione: (nessun docstring) | `verimem/skill_roi.py:37`; `verimem/smart_pruning.py:60` | nessuno | - | NON MISURATO | - |
| 2 | `verimem/skill_roi.py:27` `rank_skills_by_roi` | funzione: Rank skills by ROI desc. Returns ranked list + scan count. | `verimem/mcp_server.py:10374`; `verimem/mcp_server.py:10375`; `verimem/skill_roi.py:57` | `tests/test_skill_roi.py` | - | NON MISURATO | - |
