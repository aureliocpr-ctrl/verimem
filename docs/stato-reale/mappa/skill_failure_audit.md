# `verimem/skill_failure_audit.py`
...
```
tool MCP        hippo_skill_failure_audit
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_failure_audit.py:12` `skill_failure_audit` | funzione: Return per-skill failure breakdown. | `verimem/mcp_server.py:12039`; `verimem/mcp_server.py:12048`; `verimem/skill_failure_audit.py:57` (+2) | `tests/test_skill_failure_audit.py` | - | NON MISURATO | - |
