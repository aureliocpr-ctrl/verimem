...
```
tool MCP        hippo_skill_merge_pair
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_merge_pair.py:12` `merge_skill_pair` | funzione: Merge two skills atomically. | `verimem/mcp_server.py:11297`; `verimem/mcp_server.py:11298`; `verimem/skill_merge_pair.py:83` | `tests/test_skill_merge_pair.py` | - | NON MISURATO | - |
