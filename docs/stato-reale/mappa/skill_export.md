...
```
tool MCP        hippo_skills_export_all
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_export.py:24` `export_all_skills` | funzione: Return all skills as portable JSON-compatible dicts. | `verimem/mcp_server.py:12080`; `verimem/mcp_server.py:12081`; `verimem/skill_export.py:57` | `tests/test_skill_export_batch.py` | - | NON MISURATO | - |
