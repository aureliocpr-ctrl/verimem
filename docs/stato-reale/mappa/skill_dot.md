...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_dot.py:26` `_escape_label` | funzione: Escape characters that break DOT label syntax. | `verimem/skill_dot.py:58` | nessuno | - | NON MISURATO | - |
| 2 | `verimem/skill_dot.py:31` `skills_to_dot` | funzione: Generate a Graphviz DOT representation of the skill library. | `verimem/mcp_server.py:12234`; `verimem/mcp_server.py:12239`; `verimem/skill_dot.py:72` | `tests/test_skill_dot.py` | - | NON MISURATO | - |
