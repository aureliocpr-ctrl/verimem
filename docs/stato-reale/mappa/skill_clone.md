...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_clone.py:22` `clone_skill` | funzione: Deep-clone a skill into a fresh candidate. | `verimem/mcp_server.py:9000`; `verimem/mcp_server.py:11796`; `verimem/mcp_server.py:11802` (+1) | `tests/test_skill_clone.py`; `tests/test_skill_import_sanitize_r3.py` | - | NON MISURATO | - |
