# `verimem/skill_compile_macro.py`
...
```
tool MCP        hippo_skill_compile_macro
...
|---|---|---|---|---|---|---|---|
| 1 | `verimem/skill_compile_macro.py:18` `compile_macro` | funzione: Extract + optionally persist `compiled_macro` from parent_skills. | `verimem/mcp_server.py:11309`; `verimem/mcp_server.py:11310`; `verimem/skill_compile_macro.py:92` (+3) | `tests/test_compilation.py`; `tests/test_skill_compile_macro.py` | - | NON MISURATO | - |
