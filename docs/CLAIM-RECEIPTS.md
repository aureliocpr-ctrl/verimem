...
| 6 | «cartel 0.90→0.20, honest 0.95, HaluEval 3/3 seeds» | 🔬 (meccanismo ✅, numeri esatti da rifare) | `independence_validation --seed 11` ri-eseguito 2026-07-16: MECCANISMO confermato e anzi MIGLIORE del claim — cartello naive **0.97** → independence-aware **0.056** (deconf 0.067), honest 0.48→**0.93**. MA i numeri ESATTI del README (0.90/0.20/0.95) sono su HaluEval REALE (`source_trust_realcorpus`), non su questa simulazione → ri-eseguire il bench giusto per allineare i numeri pubblicati. |
