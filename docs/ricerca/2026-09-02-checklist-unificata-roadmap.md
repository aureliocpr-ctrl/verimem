...
| V5 | CodeQL verde | R07-22 D13 | **A METÀ** | `.github/codeql/codeql-config.yml` esiste; **nessun workflow codeql** in `.github/workflows/` | La config di esclusione c'è, il job no |
